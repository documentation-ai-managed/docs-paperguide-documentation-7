...
To get started with Paperguide, create an account and verify your email address. Once verified, you can access the full suite of research tools.
...
<Columns cols={2}>
  ...
  <Card title="Import Papers" icon="file-text" href="#import-papers">
