...
<Columns cols={3}>
  <Card title="Research Assistant" icon="search" href="#research-assistant">
    Discover and analyze academic papers with AI-powered insights and recommendations.
  </Card>
  <Card title="Reference Manager" icon="book" href="#reference-manager">
    Organize and cite your sources efficiently with automated reference generation.
  </Card>
  <Card title="Writing Assistant" icon="edit" href="#writing-assistant">
...
<Tabs>
  <Tab title="Smart Discovery" icon="search">
    ...
    <Steps>
      ...
      <Step title="Define Search Criteria" icon="filter">
        Specify your research interests, keywords, or topics of interest.
      </Step>
      <Step title="Review Recommendations" icon="check-circle">
